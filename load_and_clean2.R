...
system(paste(pyscript, "../data/CC_Edgelist.csv"))
system(paste(pyscript, "../data/Mentee_Attributes.csv"))
system(paste(pyscript, "../data/Staff_Attributes.csv"))
...
add_labels <- function(df)
{
  ...
  df$semester = factor(df$semester, levels=c("f15", "f16", "s16"), labels=c("Fa15", "Fa16", "Sp16"))
  return(df)
}
